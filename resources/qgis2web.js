...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Ejercicio2: complemento "qgis2web"</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (76 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Este visor se ha desarrollado como práctica usando el complemento "qgis2web"';
            }
